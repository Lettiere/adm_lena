...
<script>
    ...
    if (polarChart) {
        const polarChartVar = new Chart(polarChart, {
            type: 'polarArea',
            data: {
                labels: ['Escola Municipal de Belo Campo', 'Escola Afrodisio', 'Escola Vitório Oliveira',
                    'Escola Bela Vista', 'Escola Roberto Santos', 'Escola Edvaldo Flores'
                ],
                datasets: [{
...
<script>
    $(document).ready(function() {
        ...
        $('#nomeSelect').on('select2:select', function(e) {
            ...
            container.append(
                '<div class="additional-inputs"></div>'); // Adiciona um contêiner para os inputs adicionais
