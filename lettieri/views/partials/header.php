        ...
        <div class="app-brand akashi">
          <a href="index.php" class="app-brand-link">
            ...
            <img class="img-fluid app-brand-text akashi menu-tex" height="40" alt=""
              src="./assets/img/brand/logo-akashi-dark.png" data-app-light-img="brand/logo-akashi-light.png"
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div class="text-truncate" data-i18n="Administração">Administração</div>
            </a>
            <ul class="menu-sub">

              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <div class="text-truncate" data-i18n="Senso">Senso</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="cadastrar_cidadao.php" class="menu-link">
                      <div class="text-truncate" data-i18n="Alunos">Alunos</div>
                    </a>
                  </li>
                  <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="pre_matricula.php" class="menu-link">
                  <div class="text-truncate" data-i18n="Matricula">Senso</div>
                </a>
              </li>
            </ul>
          </li>
      ...
      <div class="layout-page">
        <nav
                ...
                <div class="dropdown-menu dropdown-menu-end py-0">
                  <div class="dropdown-menu-header border-bottom">
                    <div class="dropdown-header d-flex align-items-center py-3">
                      <h5 class="text-body mb-0 me-auto"><i class='bx bx-buildings'></i> Secretarias</h5>
                      <a href="#!" class="dropdown-shortcuts-add text-body" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="Ação Aqui"><i class="bx bx-sm bx-plus-circle"></i></a>
                    </div>
                  </div>
                  <div class="dropdown-shortcuts-list scrollable-container">
                    <div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
                        ...
                        <small class="text-muted mb-0"><span class="badge bg-label-primary">ATIVO</span></small>
                      </div>
                      <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                        ...
                        <small class="text-muted mb-0"><span class="badge bg-label-danger">MANUTENÇÃO</span></small>
                      </div>
                    </div>
                    <div class="row row-bordered overflow-visible g-0">
                      <div class="dropdown-shortcuts-item col">
          ...
          <div class="navbar-search-wrapper search-input-wrapper d-none">
            <input type="text" class="form-control search-input container-xxl border-0" placeholder="Procurar..."
              aria-label="Procurar..." />
