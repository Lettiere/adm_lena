                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <label for="pesquisar">Filtro:</label>
                                        <select id="pesquisar" class="form-select select2" >
                                            <option value="" selected disabled>Selecione uma opção</option>
                                            <option value="aluno1">Rua</option>
                                            <option value="aluno2">Bairro</option>
                                            <option value="aluno3">Povoado</option>
                                            <option value="aluno3">Distrito</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-3 mt-4 ">
                                        <a href="cad_rota_aluno.html" class="btn btn-warning text-nowrap">
                                            <i class="bx bx-user-plus me-1"></i> Consultar 
                                        </a>
                                    </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    <a href="cad_rota_aluno.php" class="btn btn-warning text-nowrap">
                                        <i class="bx bx-user-plus me-1"></i> Confirmar
                                    </a>
                                </div>
                            </div>
                            <h3>Selecionados</h3>
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    <a href="cad_rota_aluno.php" class="btn btn-warning text-nowrap">
                                        <i class="bx bx-user-plus me-1"></i> Associar
                                    </a>
                                </div>
                            </div>
                        </div>
