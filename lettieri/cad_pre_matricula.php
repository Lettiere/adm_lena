        ...
        <div class="bs-stepper-header">
            <div class="step" data-target="#aluno-part">
                <button type="button" class="step-trigger">
                    ...
                    <span class="bs-stepper-label"> Dados do Aluno</span>
                </button>
            </div>
            <div class="line"></div>
            <div class="step" data-target="#dados-part">
                <button type="button" class="step-trigger">
                    ...
                    <span class="bs-stepper-label">Documentação</span>
                </button>
            </div>
            <div class="line"></div>
            <div class="step" data-target="#pre-matricula-part">
                <button type="button" class="step-trigger">
                    ...
                    <span class="bs-stepper-label">Comomrbidades </span>
                </button>
            </div>
            <div class="line"></div>
            <div class="step" data-target="#instituicoes-part">
                <button type="button" class="step-trigger">
                    ...
                    <span class="bs-stepper-label">intenção de Matricula</span>
                </button>
            </div>
        </div>
                ...
                <div class="col-12 mt-3 mb-3">
                    ...
                    <div class="row">
                        <div class="form-group col-4">
                            <label for="tipoMatricula">Informe Período Letivo</label>
                    ...
                    <div id="camposPreMatricula" style="display:none;" class="mt-3">
                        ...
                        <div class="row">
                            <p>Transporte</p>
                            <div class="form-group col-4 ">
                                <label for="cidades">Usa transporte público?</label>
        ...
        <div id="instituicoes-part" class="content">
            ...
            <div class="col-xl-12">
                <div class="row mb-3">
                    ...
                    <div class="col-4">
                        <div id="selectEscolas" class="hidden mb-3">
                            <label for="escolas" class="form-label">Escola de Destinho:</label>
                            <select id="escolas" name="escolas" class="form-select" onchange="showAdditionalSelect()">
                    ...
                    <div class="col-4">
                        <div id="selectEscolas" class="hidden mb-3">
                            <label for="escolas" class="form-label"> Escola Destino:</label>
                            <select id="escolas" name="escolas" class="form-select" onchange="showAdditionalSelect()">
                                <option value="" selected>Selecione uma escola</option>
                                <option value="escola1">Escola 1</option>
                                <option value="escola2">Escola 2</option>
                ...
                <div class="col-4">
                        <div id="" class="">
                            <label for="" class="form-label"> Escola Origem</label>
                            <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="m odal" aria-label="Fechar">
